...
class Command(BaseCommand):
    ...
    def create_pokemon_cards(self):
        card1 = PokemonCard(name="Pikachu", rarity="Rare", hp=60, card_type="Electric", 
                            attack="Thunder Shock", description="A mouse-like pokemon that can generate electricity.",
